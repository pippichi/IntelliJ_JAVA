...
public class P223_Response {
    ...
    //存储正文长度
    private int len = 0;
    public P223_Response(){
        headInfo = new StringBuilder();
        content = new StringBuilder();
        len = 0;
    }
    public P223_Response(OutputStream os){
        this();
        bw = new BufferedWriter(new OutputStreamWriter(os));
    }
    public P223_Response(Socket client) {
        this();
        try {
     ...
     * 构建正文
     */
    public P223_Response print(String con){
        content.append(con);
     ...
     * 构建正文+回车
     */
    public P223_Response println(String con){
    ...
    //推送到客户端
    public void pushToClient(int c){
        if(headInfo==null){
            c = 500;
        }
        createHeadInfo(c);
