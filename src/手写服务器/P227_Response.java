...
public class P227_Response {
    ...
    //存储正文长度
    private int len = 0;
    public P227_Response(){
        headInfo = new StringBuilder();
        content = new StringBuilder();
        len = 0;
    }
    public P227_Response(OutputStream os){
        this();
        bw = new BufferedWriter(new OutputStreamWriter(os));
    }
    public P227_Response(Socket client) {
        this();
        try {
     ...
     * 构建正文
     */
    public P227_Response print(String con){
        content.append(con);
     ...
     * 构建正文+回车
     */
    public P227_Response println(String con){
